    ...
    <section className='flexCenter flex-col'>
      ...
      >
        <Image
          ...
          height={50}
        />
        <p className='uppercase regluar-18 -mt-1 mb-3 
        text-green-50'
        >
          we are here for you
        </p>
        ...
        >
          ...
          >
            ...
            get lost and get lost again, because we already support offline 
            maps when there is no internet connection in the field. Invite 
            your friends, relatives and friends to have fun in the wilderness through the 
